    ...
    D.prototype = {
      ...
      applyTextOutline: function(a) {
        ...
        TotalPriceChartData.forEach(function(d){
          if(d.Total_ClosePrice === parseInt(g[0].innerHTML.replace(/ /g,''))){
            if(d.Total_ClosePrice > d.Total_ListPrice){
              g[0].innerHTML = d.Number_of_Transactions.toString();
            }else{
              g[0].innerHTML = '';
            }
          };
          if(d.Total_ListPrice === parseInt(g[0].innerHTML.replace(/ /g,''))){
            if(d.Total_ClosePrice < d.Total_ListPrice){
              g[0].innerHTML = d.Number_of_Transactions.toString();
            }else{
              g[0].innerHTML = '';
