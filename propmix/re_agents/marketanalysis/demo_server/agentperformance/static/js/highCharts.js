  ...
  (function(a) {
    ...
    D.prototype = {
      ...
      applyTextOutline: function(a) {
        ...
        TotalPriceChartData.forEach(function(d){
          if(d.Total_ClosePrice_Sold === parseInt(g[0].innerHTML.replace(/ /g,''))){
            g[0].innerHTML = d.Number_of_Transactions_Close.toString();
          };
          if(d.Total_ListPrice_Sold === parseInt(g[0].innerHTML.replace(/ /g,''))){
            g[0].innerHTML = d.Number_of_Transactions_List.toString();
          };
        });
