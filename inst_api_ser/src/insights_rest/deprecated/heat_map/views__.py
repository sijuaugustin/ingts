...
#     print data
    ...
    #calc = {{"Postalcode": data[i]['_id']['PostalCode']}:{ "closeprice": data[i]['5Y']['ClosePrice'], "listprice": data[i]['5Y']['ListPrice'],"price_sqft": data[i]['5Y']['price_sqft'],"NumberOfTransactions": data[i]['5Y']['NumberOfTransactions']}}
                ...
                calc = {"postalcodes":pc,"HEAT_5Y":{ "closeprice": data[i]['5Y']['ClosePrice'], "listprice": data[i]['5Y']['ListPrice'],"price_sqft": data[i]['5Y']['price_sqft'],"NumberOfTransactions": data[i]['5Y']['NumberOfTransactions']},"HEAT_1Y":{ "closeprice": data[i]['1Y']['ClosePrice'], "listprice": data[i]['1Y']['ListPrice'],"price_sqft": data[i]['1Y']['price_sqft'],"NumberOfTransactions": data[i]['1Y']['NumberOfTransactions']},"HEAT_6M":{ "closeprice": data[i]['6M']['ClosePrice'], "listprice": data[i]['6M']['ListPrice'],"price_sqft": data[i]['6M']['price_sqft'],"NumberOfTransactions": data[i]['6M']['NumberOfTransactions']},"HEAT_3M":{ "closeprice": data[i]['3M']['ClosePrice'], "listprice": data[i]['3M']['ListPrice'],"price_sqft": data[i]['3M']['price_sqft'],"NumberOfTransactions": data[i]['3M']['NumberOfTransactions']},"HEAT_1M":{ "closeprice": data[i]['1M']['ClosePrice'], "listprice": data[i]['1M']['ListPrice'],"price_sqft": data[i]['1M']['price_sqft'],"NumberOfTransactions": data[i]['1M']['NumberOfTransactions']}}
